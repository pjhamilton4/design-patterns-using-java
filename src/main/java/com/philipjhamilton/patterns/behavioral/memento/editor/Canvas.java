package com.philipjhamilton.patterns.behavioral.memento.editor;

import com.philipjhamilton.patterns.behavioral.memento.command.ColorCommand;
import com.philipjhamilton.patterns.behavioral.memento.command.MoveCommand;
import com.philipjhamilton.patterns.behavioral.memento.shapes.Shape;
    ...
    private void attachMouseListeners() {
        ...
        MouseAdapter selector = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.philipjhamilton.patterns.behavioral.memento.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
